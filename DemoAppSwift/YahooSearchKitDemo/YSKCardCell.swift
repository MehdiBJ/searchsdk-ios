...
class YSKCustomCardCell: UITableViewCell {
    ...
    func addSubviews() {
        ...
        reblogImage.translatesAutoresizingMaskIntoConstraints = false
    ...
    func addConstraints() {
        ...
        self.contentView.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:|-16-[title]-16-|", options:NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewsDictionary))
        self.contentView.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:|[blogImage]|", options:NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewsDictionary))
        self.contentView.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:|-16-[caption]-16-|", options:NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewsDictionary))
        self.contentView.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:|-16-[tags]-[reblogImage(19)]-6-[likeImage(19)]-16-|", options:NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewsDictionary))
        ...
        self.contentView.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|-16-[title]-16-[blogImage(210)]-16-[caption]-16-[likeImage(19)]-20-|", options:NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewsDictionary))
    }
